...
def show_help():
    ...
    <ul>
        ...
        <li><b>Анализ текста:</b> Нажмите кнопку "Анализировать" для выполнения синтаксического и семантического анализа. Результаты появятся в виде дерева зависимостей.</li>
        <li><b>Просмотр результатов:</b> Дерево показывает Идентификатор, Слово, Часть речи, Член предложения, К какому слову относится, Лемму и Семантическую роль для каждого токена.</li>
        <li><b>Сохранение результатов:</b> Нажмите "Сохранить результаты" для экспорта в JSON-файл.</li>
        <li><b>Редактирование:</b> Дважды щелкните по узлу для редактирования данных (Часть речи, Член предложения, Лемма, Семантическая роль).</li>
        <li><b>Документирование:</b> Результаты можно экспортировать в текстовый формат для отчета через "Документировать".</li>
    </ul>
    <h3>Советы:</h3>
    <ul>
